...
export default function Projects() {
  ...
  const projects = [
    ...
    {
      title: 'Banking Test Automation Platform',
      description: 'Production-ready test automation framework using Playwright codegen for visual test recording. Integrates Twilio OTP automation with real-time uptime monitoring for comprehensive banking application testing.',
      icon: Shield,
      tags: ['Python', 'Playwright', 'Twilio', 'WebKit/Safari', 'Node.js'],
      github: '#contact',
      demo: '#contact',
    ...
    },
    {
      ...
      description: 'Enterprise-grade API service with function calling, real-time analytics, and monitoring dashboard. Supports 3-4 concurrent users with rate limiting, cost tracking, and Cloudflare tunnel integration.',
      icon: Bot,
    ...
    {
      title: 'Dual-Strategy Trading Bot Platform',
      description: 'VPS-deployed Freqtrade system running NFI conservative and scalping strategies. Features Docker orchestration, PostgreSQL persistence, and real-time monitoring with Kraken exchange integration.',
      icon: TrendingUp,
      tags: ['Python', 'Docker', 'Freqtrade', 'PostgreSQL', 'Kraken API'],
      github: '#contact',
      demo: '#contact',
